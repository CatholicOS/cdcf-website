...
function cdcf_mcp_member_input_schema(bool $require_collab = false): array {
    $schema = [
        ...
        'properties' => [
            ...
            'member_title'        => ['type' => 'string', 'description' => 'Subheader shown directly under the person\'s name on their bio card (and as the subtitle on their author page) — their position or affiliation, e.g. "Foundation President" or "Professor of Theology, University of Notre Dame". NOT an honorific prefix: do not put "Dr." / "Rev." here (those belong in the name/title).'],
            'member_role'         => ['type' => 'string', 'description' => 'Currently unused — not displayed anywhere on the site. Omit it.'],
        ...
        [
            ...
            'input_schema'=> [
                ...
                'properties' => [
                    ...
                    'member_title'        => ['type' => 'string', 'description' => 'Subheader under the name on the bio card (position/affiliation, e.g. "Professor of Theology, University of Notre Dame") — NOT an honorific like "Dr."/"Rev.".'],
                    'member_role'         => ['type' => 'string', 'description' => 'Currently unused — not displayed anywhere on the site. Omit it.'],
