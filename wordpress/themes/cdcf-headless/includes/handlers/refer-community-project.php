<?php
/**
 * REST route handler for /cdcf/v1/refer-community-project.
 *
 * Sibling of /cdcf/v1/refer-local-group: same verification-code flow,
 * different target CPT (`community_project`) and different optional
 * ACF fields (category / project_url / github_url) plus the
 * project_tag taxonomy assignment.
 *
